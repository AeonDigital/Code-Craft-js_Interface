    ...
    var newInterfaceMethods = {
        ...
        */
        SetAnchorAnimation : function () {
	        var evt_AncScroll = function() {
		        Interface.ScrollToAnchor(document.getElementById((this.href.split('#')[1])));
	        };
        ...
        */
        AbsoluteCoords : function(o, x, y) {
	        ...
	        for(var i=0; i<o.length; i++) {
		        ...
		        x = (x - Interface.GetScrollX(elem)) + 'px';
		        y = (y - Interface.GetScrollY(elem)) + 'px';
        ...
        */
        AlignToCenterScreen : function(o, ax) {
	        ...
	        var sX = Interface.GetScrollX(dc);
	        var sY = Interface.GetScrollY(dc);
	        ...
	        for(var i=0; i<o.length; i++) {
		        ...
		        if (ax.indexOf('x') != -1) {
			        el.style.left = '0';
			        el.style.left = (((wX - el.offsetWidth) / 2) + sX - Interface.GetScrollX(el)) + 'px';
		        }
		        // Alinha pelo eixo Y
		        if (ax.indexOf('y') != -1) {
			        el.style.top = '0';
			        var finalY = (((wH - el.offsetHeight) / 2) + sY - Interface.GetScrollY(el));
